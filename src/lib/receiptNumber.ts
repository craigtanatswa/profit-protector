...
/**
 * 6 characters: 4 decimal digits (0001–9999) + 2 letters (A–Z).
...
export function formatShortReceipt6(countIndex: number): string {
  ...
  return dStr + String.fromCharCode(65 + l1) + String.fromCharCode(65 + l2)
}

/** 6 char fallback when the bounded sequence is exhausted; cryptographically unique. */
